...
import { ArrowLeft, FileText, Code2, ExternalLink, Quote, BookOpen } from "lucide-react"
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const pub = await getPublicationBySlug(slug).catch(() => null)
  if (!pub) return {}
  return {
    title: pub.title,
          ...
          {pub.contributions && (
            <div className="mb-10">
              ...
              <ul className="space-y-2">
                {(pub.contributions as string[]).map((c, i) => (
