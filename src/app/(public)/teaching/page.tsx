...
import { GraduationCap, Calendar, User, Building2, ChevronRight } from "lucide-react"
    ...
    <Section className="pt-32">
      <Container>
        <div className="max-w-4xl">
          <ScrollReveal>
            <Badge variant="default" size="lg" className="mb-5"><GraduationCap size={12} className="mr-1.5" /> Teaching Experience</Badge>
